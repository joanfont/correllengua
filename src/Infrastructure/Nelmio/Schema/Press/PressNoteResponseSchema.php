...
#[OA\Schema(
    properties: [
        ...
        new OA\Property(property: 'subtitle', type: 'string', example: 'Join us for the biggest event of the year'),
        ...
        new OA\Property(property: 'image', type: 'string', example: '/uploads/2025/11/25/image.jpg'),
...
final class PressNoteResponseSchema
{
}

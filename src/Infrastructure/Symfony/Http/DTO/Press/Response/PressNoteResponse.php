...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'subtitle', type: 'string', nullable: true, example: 'Join us for the biggest event of the year'),
        ...
        new OA\Property(property: 'imageUrl', type: 'string', nullable: true, example: '/uploads/2025/11/25/image.jpg'),

...
#[OA\Schema(
    properties: [
        ...
        new OA\Property(property: 'subtitle', type: 'string', example: 'Join us for the biggest event of the year', nullable: true),
        ...
        new OA\Property(property: 'imageUrl', type: 'string', example: '/uploads/2025/11/25/image.jpg', nullable: true),

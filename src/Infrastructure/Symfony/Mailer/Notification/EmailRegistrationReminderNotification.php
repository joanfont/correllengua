...
class EmailRegistrationReminderNotification implements RegistrationReminderNotification
{
    ...
    public function send(array $registrations): void
    {
        ...
        $email
            ->from($this->from)
            ->subject('Recordatori - Correllengua Agermanat')
            ->to($to)
    ...
    private function buildContext(Participant $participant, array $registrations): array
    {
        ...
        foreach ($registrations as $registration) {
            ...
            $segments[] = [
                ...
                'routeDate' => $segment->routeDate?->format('d/m/Y'),
